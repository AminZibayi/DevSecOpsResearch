...
<div class="mt-2 space-y-2">
  <div class="bg-[var(--slidev-theme-code-background)] p-3 rounded-lg border-l-4 border-[var(--slidev-theme-accents-blue)]">
    <h3 class="font-bold text-white text-lg mb-1">Monorepo Consolidation & Nx Setup</h3>
  ...
  <div class="bg-[var(--slidev-theme-code-background)] p-3 rounded-lg border-l-4 border-[var(--slidev-theme-accents-blue)]">
    <h3 class="font-bold text-white text-lg mb-1">"Source of Truth" Governance</h3>
  ...
  <div class="bg-[var(--slidev-theme-code-background)] p-3 rounded-lg border-l-4 border-[var(--slidev-theme-accents-blue)]">
    <h3 class="font-bold text-white text-lg mb-1">Shift-Left Local Security</h3>
...
<div class="mt-3 space-y-3">
  <div class="bg-[var(--slidev-theme-code-background)] p-3 rounded-lg border-l-4 border-[var(--slidev-theme-accents-teal)]">
    <h3 class="font-bold text-white text-lg mb-1">Deterministic Security Scanning</h3>
  ...
  <div class="bg-[var(--slidev-theme-code-background)] p-3 rounded-lg border-l-4 border-[var(--slidev-theme-accents-teal)]">
    <h3 class="font-bold text-white text-lg mb-1">Supply Chain Integrity (SBOM & SLSA)</h3>
  ...
  <div class="bg-[var(--slidev-theme-code-background)] p-3 rounded-lg border-l-4 border-[var(--slidev-theme-accents-teal)]">
    <h3 class="font-bold text-white text-lg mb-1">Policy-as-Code Gates</h3>
...
<div class="mt-3 space-y-3">
  <div class="bg-[var(--slidev-theme-code-background)] p-3 rounded-lg border-l-4 border-[var(--slidev-theme-accents-yellow)]">
    <h3 class="font-bold text-white text-lg mb-1">Agent Harness Rollout</h3>
  ...
  <div class="bg-[var(--slidev-theme-code-background)] p-3 rounded-lg border-l-4 border-[var(--slidev-theme-accents-yellow)]">
    <h3 class="font-bold text-white text-lg mb-1">Agentic PR Reviews</h3>
  ...
  <div class="bg-[var(--slidev-theme-code-background)] p-3 rounded-lg border-l-4 border-[var(--slidev-theme-accents-yellow)]">
    <h3 class="font-bold text-white text-lg mb-1">Self-Healing CI Experiments</h3>
...
<div class="mt-3 overflow-hidden rounded-lg border border-[var(--slidev-theme-code-border)]">
  <table class="w-full text-sm text-left">
    <thead class="bg-[var(--slidev-theme-code-background)]">
      <tr>
        <th class="p-3 w-24">Level</th>
        <th class="p-3 w-40">Name</th>
        <th class="p-3">Characteristics</th>
      </tr>
    </thead>
    <tbody class="divide-y divide-[var(--slidev-theme-code-border)]">
      <tr>
        <td class="p-3 font-bold">Level 1</td>
        <td class="p-3 font-bold">Ad-hoc</td>
        <td class="p-3 text-gray-400">Manual security reviews, fragmented repos, AI used only for autocomplete.</td>
      </tr>
      <tr>
        <td class="p-3 font-bold">Level 2</td>
        <td class="p-3 font-bold">Repeatable</td>
        <td class="p-3 text-gray-400">Deterministic SAST/SCA in CI, pre-commit hooks, basic linting rules.</td>
      </tr>
      <tr>
        <td class="p-3 font-bold">Level 3</td>
        <td class="p-3 font-bold">Defined</td>
        <td class="p-3 text-gray-400">Monorepo (Nx) adoption, SBOM generation, centralized policy-as-code.</td>
      </tr>
      <tr>
        <td class="p-3 font-bold text-[var(--slidev-theme-accents-teal)]">Level 4</td>
        <td class="p-3 font-bold text-[var(--slidev-theme-accents-teal)]">Managed</td>
        <td class="p-3 text-gray-300">Agentic PR reviews, diff-aware risk scoring, signed provenance for artifacts.</td>
      </tr>
      <tr class="bg-[var(--slidev-theme-code-background)]">
        <td class="p-3 font-bold text-[var(--slidev-theme-accents-yellow)]">Level 5</td>
        <td class="p-3 font-bold text-[var(--slidev-theme-accents-yellow)]">Optimizing</td>
        <td class="p-3 text-gray-200"><strong>AI-Native:</strong> Self-healing CI, autonomous incident response, 3-gate runtime.</td>
      </tr>
    </tbody>
  </table>
</div>