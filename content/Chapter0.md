...
However, this increased velocity comes with a documented risk profile. A 2026 industry study revealed that **25.7% of AI-generated code contains confirmed vulnerabilities**, with "Injection" (A05) and "Mishandling of Exceptional Conditions" (A10) being the most prevalent. While newer models like GPT-5.2 have improved the safety baseline (vulnerability rate of 19.5%), other widely used agents like Llama 4 Maverick still exhibit rates as high as 29.9% (Tier 3 Source).
