...
A growing body of structured practitioner knowledge is emerging to address this gap. As of early 2026, the open-source community has produced the **Anthropic Cybersecurity Skills library** — a repository of 754 production-grade cybersecurity skills mapped across five industry frameworks (MITRE ATT&CK v19.1, NIST CSF 2.0, MITRE ATLAS v5.4, MITRE D3FEND v1.3, and NIST AI RMF 1.0) and spanning 26 security domains. The library's DevSecOps subdomain alone contains 16 skills covering SAST, DAST, SCA, IaC auditing, code signing, SBOM analysis, in-toto supply chain verification, and CI/CD pipeline hardening. These skills encode real practitioner workflows — specific tool configurations, YAML pipeline definitions, OPA Rego policies, and verification checklists — making them a valuable empirical reference for this report's architectural recommendations.

**AI-Native DevSecOps** represents the convergence of these trends. It is not merely using AI to scan code; it is a fundamental re-architecting of the SDLC where AI agents are first-class participants. This evolution introduces a critical paradox: while AI can accelerate security (e.g., automated triage and remediation), it also introduces non-deterministic risks (e.g., hallucinated dependencies and prompt injection). This report investigates how to harness this power while maintaining the rigor of modern DevSecOps, drawing concrete implementation guidance from the mapped skill library where applicable.
